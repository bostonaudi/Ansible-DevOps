...
$scriptBlock = {
    param($buildDropLocation,$SQLInstance,$databaseKey,$ReportInstance,$Product,$AGListener)

    $libraryVersion = "\\ptlserver9\CrmPowershell\RELEASE\CRMManifest.psd1"
...
Invoke-Command -ComputerName $env:ComputerName -scriptblock $scriptBlock -credential $creds -Authentication Credssp -ArgumentList $buildDropLocation,$SQLInstance,$databaseKey,$ReportInstance,$Product,$AGListener
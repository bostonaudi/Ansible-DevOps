...
$scriptBlock = {
    param($buildDropLocation, $agents, $databasePath)
...
Invoke-Command -ComputerName $env:ComputerName -scriptblock $scriptBlock -credential $creds -Authentication Credssp -ArgumentList $buildDropLocation,$agents,$databasePath

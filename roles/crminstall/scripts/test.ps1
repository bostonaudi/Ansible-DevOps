...
Write-Host "Changing web.config"
Set-CRMDatabaseEntry -installDir $baseInstallDir -databaseKey $databaseKey -connectionString $ConnectionString

Write-Host "Regenerating the encryption key."
